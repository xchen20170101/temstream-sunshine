...
> **⚠️ Fork Notice**
>
> 本目录是 [LizardByte/Sunshine](https://github.com/LizardByte/Sunshine) 的**定制版本**，用于 Temstream Sunshine 项目。
>
> 主要本地修改：
> - 增加了与管理后端的 TCP 通信（端口 `12345`），用于动态 PIN 签发、注册、心跳
> - 新增 `config/sunshine_server.ini` 配置（管理端 IP、Tailscale / Headscale 选项、LAN 固定 PIN 模式）
> - 大量中文注释
> - 移除 / 简化了 Tailscale 自动登录相关代码
>
> 原始上游说明保留如下。如需查看完整上游 README，请访问：
> <https://github.com/LizardByte/Sunshine/blob/master/README.md>
