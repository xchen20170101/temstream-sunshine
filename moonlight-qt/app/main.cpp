...
LONG WINAPI UnhandledExceptionHandler(struct _EXCEPTION_POINTERS *ExceptionInfo)
{
    ...
    swprintf_s(dmpFileName, L"%ls\\TemStream-%I64u.dmp",
...
int main(int argc, char *argv[])
{
    ...
    QCoreApplication::setOrganizationName("TemStream Project");
    QCoreApplication::setOrganizationDomain("temstream.com");
    QCoreApplication::setApplicationName("TEMSTREAM");
    ...
    s_LoggerFile = new QFile(tempDir.filePath(QString("TemStream-%1.log").arg(QDateTime::currentSecsSinceEpoch())));
    ...
    QStringList existingLogNames = tempDir.entryList(QStringList("TemStream-*.log"), QDir::NoFilter, QDir::SortFlag::Time);
    ...
    SDL_SetHint("SDL_AUDIO_DEVICE_APP_NAME", "TemStream");
    SDL_SetHint("SDL_APP_NAME", "TemStream");
    ...
    app.setDesktopFileName("com.temstream.TemStream.desktop");
    qputenv("SDL_VIDEO_WAYLAND_WMCLASS", "com.temstream.TemStream");
    qputenv("SDL_VIDEO_X11_WMCLASS", "com.temstream.TemStream");
    ...
    qmlRegisterSingletonType<ErrorMessages>("ErrorMessages", 1, 0,
                                           "ErrorMessages",
                                           [](QQmlEngine*, QJSEngine*) -> QObject* {
