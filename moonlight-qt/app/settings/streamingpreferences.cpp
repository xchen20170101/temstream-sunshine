...
#define SER_SERVERIP "serverIp"
#define SER_LANSERVERIP "lanServerIp"
#define SER_LANFIXEDPIN "lanFixedPin"
#define SER_LANPASSWORD "lanPassword"
#define SER_REMEMBERED_USERNAME "rememberedUsername"
#define SER_REMEMBER_USERNAME "rememberUsername"
...
void StreamingPreferences::reload()
{
    ...
    // 定制配置从 conf.ini 读取
    QSettings customSettings("./conf.ini", QSettings::IniFormat);
    serverIp = customSettings.value(SER_SERVERIP, "").toString();
    lanServerIp = customSettings.value(SER_LANSERVERIP, "").toString();
    lanFixedPin = customSettings.value(SER_LANFIXEDPIN, false).toBool();
    lanPassword = customSettings.value(SER_LANPASSWORD, "").toString();
    rememberedUsername = customSettings.value(SER_REMEMBERED_USERNAME, "").toString();
    rememberUsername = customSettings.value(SER_REMEMBER_USERNAME, false).toBool();
...
void StreamingPreferences::save()
{
    ...
    // 定制配置保存到 conf.ini
    QSettings customSettings("./conf.ini", QSettings::IniFormat);
    customSettings.setValue(SER_SERVERIP, serverIp);
    customSettings.setValue(SER_LANSERVERIP, lanServerIp);
    customSettings.setValue(SER_LANFIXEDPIN, lanFixedPin);
    customSettings.setValue(SER_LANPASSWORD, lanPassword);
    customSettings.setValue(SER_REMEMBERED_USERNAME, rememberedUsername);
    customSettings.setValue(SER_REMEMBER_USERNAME, rememberUsername);
}
