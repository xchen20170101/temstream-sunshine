...
public:
    ...
    Q_PROPERTY(QString serverIp MEMBER serverIp NOTIFY serverIpChanged)
    Q_PROPERTY(QString lanServerIp MEMBER lanServerIp NOTIFY lanServerIpChanged)
    Q_PROPERTY(bool lanFixedPin MEMBER lanFixedPin NOTIFY lanFixedPinChanged)
    Q_PROPERTY(QString lanPassword MEMBER lanPassword NOTIFY lanPasswordChanged)
    Q_PROPERTY(QString rememberedUsername MEMBER rememberedUsername NOTIFY rememberedUsernameChanged)
    Q_PROPERTY(bool rememberUsername MEMBER rememberUsername NOTIFY rememberUsernameChanged)
...
signals:
    ...
    void lanServerIpChanged();
    void lanFixedPinChanged();
    void lanPasswordChanged();
    void rememberedUsernameChanged();
    void rememberUsernameChanged();
